...
import { Header } from "../../components/Header/indedx";
        ...
        <div className="flex items-center flex-col min-h-screen pb-7 px-2">
            ...
            {links.map((links) => (
                <article
                    ...
                    style={{ backgroundColor: links.bg, color: links.color }}
                >
                    <p>{links.name}</p>
                    <div>
                        <button
                            className='border border-dashed bg-black py-1 px-1.5 rounded'
                            onClick={() => handleDeletLink(links.id)}
                        >
